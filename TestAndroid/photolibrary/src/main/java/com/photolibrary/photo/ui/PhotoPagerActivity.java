package com.photolibrary.photo.ui;
...
import com.photolibrary.photo.BaseActivity;
import com.photolibrary.photo.bean.PhotoPagerBean;
import com.photolibrary.photo.controller.PhotoPagerConfig;
import com.photolibrary.photo.util.AppPathUtil;
import com.photolibrary.photo.util.ImageUtils;
import com.photolibrary.photo.util.PermissionUtil;
import com.photolibrary.photo.widget.HackyViewPager;
import com.photolibrary.photo.widget.RoundProgressBar;
import com.photolibrary.photo.widget.photodraweeview.OnViewTapListener;
import com.photolibrary.photo.widget.photodraweeview.PhotoDraweeView;
...
//            hierarchy.setFailureImage(getResources().getDrawable(R.mipmap.failure_image));
            hierarchy.setRetryImage(getResources().getDrawable(R.drawable.ic_logo_wei));
